...
pub struct Fixture {
    ...
    pub medication_mobile_locked_household_id: i64,
    ...
    pub dose_write_medication_id: i64,
    pub dose_write_assignment_id: i64,
    pub dose_write_assignment_portable_id: String,
    pub dose_write_person_id: i64,
    pub dose_write_other_medication_id: i64,
    pub dose_write_concurrent_assignment_portable_id: String,
    pub dose_write_tracked_medication_id: i64,
    pub dose_write_tracked_option_id: i64,
    pub dose_write_tracked_assignment_portable_id: String,
    pub dose_write_timed_medication_id: i64,
    pub dose_write_timed_assignment_portable_id: String,
    pub dose_write_schedule_medication_id: i64,
    pub dose_write_schedule_id: i64,
    pub dose_write_schedule_portable_id: String,
    pub dose_write_foreign_medication_id: i64,
    pub dose_write_foreign_assignment_portable_id: String,
    pub journey_browser_desktop_medication_id: i64,
    pub journey_browser_desktop_medication_name: String,
    pub journey_browser_desktop_assignment_id: i64,
    pub journey_browser_mobile_medication_id: i64,
    pub journey_browser_mobile_medication_name: String,
    pub journey_browser_mobile_assignment_id: i64,
    pub journey_browser_person_id: i64,
    pub journey_browser_foreign_medication_id: i64,
    pub journey_browser_foreign_medication_name: String,
