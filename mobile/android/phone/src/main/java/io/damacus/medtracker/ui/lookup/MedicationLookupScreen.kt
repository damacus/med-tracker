...
fun MedicationLookupScreen(
    results: List<MedicationLookupResultDto>,
    isLoading: Boolean,
    ...
    Box(modifier = modifier.fillMaxSize()) {
        Column(
            ...
            OutlinedTextField(
                ...
                placeholder = { Text("Search dm+d database, barcode or name...") },
            ...
            if (results.isEmpty()) {
                Box(
                    ...
                    Text(
                        text = if (searchQuery.isBlank()) "Type a medication name or scan barcode to search" else "No matching medications found",
