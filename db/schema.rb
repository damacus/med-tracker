...
ActiveRecord::Schema[8.1].define(version: 20_260_223_173_000) do
  ...
  create_table 'account_active_session_keys', id: false, force: :cascade do |t|
    ...
    t.index %w[account_id session_id], name: 'index_account_active_session_keys_on_account_id_and_session_id', unique: true
  ...
  create_table 'account_webauthn_keys', force: :cascade do |t|
    ...
    t.index %w[webauthn_id account_id], name: 'index_account_webauthn_keys_on_webauthn_id_and_account_id', unique: true
  end
