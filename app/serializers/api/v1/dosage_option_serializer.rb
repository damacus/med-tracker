...
module Api
  module V1
    class DosageOptionSerializer
      ...
      def dose_data
        {
          amount: decimal_as_json(dosage_option.amount),
      ...
      def default_data
        {
          ...
          default_min_hours_between_doses: decimal_as_json(dosage_option.default_min_hours_between_doses),
      ...
      def inventory_data
        {
          current_supply: decimal_as_json(dosage_option.current_supply),
          reorder_threshold: decimal_as_json(dosage_option.reorder_threshold),
