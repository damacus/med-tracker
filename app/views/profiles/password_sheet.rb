    ...
    class PasswordSheet < Views::Base
      ...
      def render_password_fields
        div(class: "space-y-4") do
          render_password_field(
            "current_password",
            t("profiles.password_sheet.current_password_label"),
            t("profiles.password_sheet.current_password_placeholder")
          )
          render_password_field(
            "new_password",
            t("profiles.password_sheet.new_password_label"),
            t("profiles.password_sheet.new_password_placeholder")
          )
          render_password_field(
            "password_confirmation",
            t("profiles.password_sheet.confirm_password_label"),
            t("profiles.password_sheet.confirm_password_placeholder")
          )
        end
      end
      ...
      def render_sheet_footer
        render(SheetFooter.new) do
          m3_button(variant: :outlined, data: {action: "click->ruby-ui--sheet-content#close"}) {
            t("profiles.password_sheet.cancel")
          }
