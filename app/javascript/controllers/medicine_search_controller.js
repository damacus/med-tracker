...
export default class extends Controller {
  ...
  async search(event) {
    ...
    try {
      ...
      this.showError("Unable to connect to the medicine database. Please try again.")
    }
  }

  get searchUrl() {
    return "/medicine-finder/search"
  }

  showLoading() {
    this.resultsTarget.innerHTML = `
      <div class="text-center py-12 text-slate-500" data-medicine-search-target="loading">
