...
module Components
  module Layouts
    ...
    class Navigation < Components::Base
      ...
      def view_template
        header(class: 'sticky top-0 z-40 w-full border-b bg-surface-container-lowest/95 backdrop-blur ' \
                      'supports-[backdrop-filter]:bg-surface-container-lowest/60 md:hidden') do
          render_skip_link
          nav(class: 'nav') do
