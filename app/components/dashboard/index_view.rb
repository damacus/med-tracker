      ...
      def render_health_insights
        div(class: "space-y-4 pt-4") do
          ...
          m3_card(
            ...
            div(
              class: "absolute -right-12 -top-12 w-48 h-48 bg-white/10 rounded-full blur-3xl " \
                "group-hover:bg-white/20 transition-all"
            )
            div(class: "relative z-10") do
              div(
                class: "w-12 h-12 rounded-2xl bg-white/20 flex items-center justify-center mb-6 " \
