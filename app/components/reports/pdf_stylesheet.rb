        ...
        style do
          raw safe(<<~CSS)
            ...
            * { box-sizing: border-box; }
            ...
            .health-history-side-effects-table th:nth-child(1), .health-history-side-effects-table td:nth-child(1) { width: 12%; }
            .health-history-side-effects-table th:nth-child(2), .health-history-side-effects-table td:nth-child(2) { width: 15%; }
            .health-history-side-effects-table th:nth-child(3), .health-history-side-effects-table td:nth-child(3) { width: 12%; }
            .health-history-side-effects-table th:nth-child(4), .health-history-side-effects-table td:nth-child(4) { width: 15%; }
            .health-history-side-effects-table th:nth-child(5), .health-history-side-effects-table td:nth-child(5) { width: 32%; }
            .health-history-side-effects-table th:nth-child(6), .health-history-side-effects-table td:nth-child(6) { width: 14%; }
            .health-history-side-effects-table th, .health-history-side-effects-table td { padding: 2mm; }
            .health-history-illnesses-table th:nth-child(1), .health-history-illnesses-table td:nth-child(1) { width: 14%; }
            .health-history-illnesses-table th:nth-child(2), .health-history-illnesses-table td:nth-child(2) { width: 20%; }
