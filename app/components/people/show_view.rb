        ...
        div(
          ...
          div(class: "flex items-center gap-6") do
            ...
            div(class: "space-y-1") do
              div(class: "flex items-center gap-3") do
                ...
                m3_badge(
                  variant: :outlined,
                  class: "rounded-full uppercase text-[10px] font-black tracking-widest py-1 px-3"
                ) do
          ...
          div(class: "flex gap-3") do
            if view_context.policy(person).update?
              m3_link(
                href: person_path(person, editing: true),
                variant: :outlined,
                size: :lg,
            ...
            m3_link(
              ...
              variant: :text,
              size: :lg,
              class: "rounded-xl font-bold text-on-surface-variant hover:text-foreground"
            ) do
              t("people.show.back")
            end
          end
      ...
      def render_person_overview_card
        m3_card(variant: :elevated, class: "p-8 space-y-6 border-none shadow-elevation-1 rounded-[2.5rem]") do
          ...
          div(class: "space-y-4") do
            ...
            overview_item(
              t("people.overview.assigned_user"),
              person.user&.email_address || t("people.overview.no_user"),
              Icons::User
            )
            overview_item(
        ...
        div(class: "col-span-full") do
          m3_card(
            ...
            class: "text-center py-16 px-8 border-dashed border-2 border-outline-variant/50 " \
              "bg-surface-container-low rounded-[2.5rem]"
          ) do
