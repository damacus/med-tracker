...
module Components
  module Schedules
    ...
    class Card < Components::Base
      ...
      attr_reader :schedule, :person, :todays_takes, :matching_medications, :current_user

      def initialize(schedule:, person:, todays_takes: nil, matching_medications: nil, current_user: nil)
        @schedule = schedule
        @person = person
