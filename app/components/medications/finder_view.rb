        ...
        div(
          data: {
            ...
            medication_search_translations_value: {
              ...
              reviewPromptSource: t('medications.finder.review_prompt_source'),
              reviewPromptCheckedOn: t('medications.finder.review_prompt_checked_on'),
              reviewPromptDescription: t('medications.finder.review_prompt_description'),
              relatedMedicationsTitle: t('medications.finder.related_medications_title'),
              relatedMedicationsMessage: t('medications.finder.related_medications_message'),
              relatedMedicationsLocation: t('medications.finder.related_medications_location'),
              relatedMedicationsCurrentSupply: t('medications.finder.related_medications_current_supply'),
