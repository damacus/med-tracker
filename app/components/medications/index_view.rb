    ...
    class IndexView < Components::Base
      ...
      def render_inventory_frame
        turbo_frame_tag(
          ...
          data: {testid: "medications-content"}
        ) do
          ...
          div(class: "flex items-center gap-6") do
            ...
            div(class: "space-y-1") do
              m3_text(
                size: "2",
                weight: "bold",
                class: "uppercase tracking-[0.2em] opacity-40 block mb-1 font-black"
              ) do
      ...
      def render_filters_section
        render(
          Components::Medications::SearchComponent.new(
            current_category: current_category,
            categories: categories,
            locations: locations,
            current_location_id: current_location_id
      ...
      def render_medications_grid
        if medications.any?
          ...
          render(
            Components::Shared::EmptyState.new(
