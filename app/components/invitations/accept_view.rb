    ...
    class AcceptView < Components::Base
      ...
      def header_section
        div(class: "mx-auto max-w-xl text-center space-y-3") do
          m3_heading(level: 1, class: "text-4xl font-bold tracking-tight text-foreground sm:text-5xl") {
            t("app.name")
          }
        ...
        form_with(
          ...
          FormField do
            ...
            m3_input(
              ...
              readonly: true,
              class: "bg-secondary-container/70"
            )
          end
          ...
          m3_button(type: :submit, variant: :filled, size: :md, class: "w-full") {
            t("invitations.accept.form.submit")
          }
        end
      end
    end
