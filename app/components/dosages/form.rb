  ...
  module Dosages
    ...
    class Form < Components::Base
          ...
          FREQUENCY_SUGGESTIONS.each do |suggestion|
            button(
              ...
              class: "inline-flex shrink-0 items-center rounded-full border " \
                ...
                "text-xs font-medium text-on-surface-variant shadow-sm " \
                "whitespace-nowrap hover:bg-tertiary-container hover:border-border " \
      ...
      def render_divider
        ...
        p(class: "text-xs font-semibold text-on-surface-variant uppercase tracking-wider mb-1") do
      ...
      def render_scheduling_defaults
        div(class: "grid grid-cols-3 gap-4") do
          FormField do
            ...
            m3_input(
              type: :number,
              name: "dosage[default_max_daily_doses]",
          ...
          FormField do
            ...
            m3_input(
              type: :number,
              name: "dosage[default_min_hours_between_doses]",
      ...
      def render_default_flags
        div(class: "flex gap-6 mt-2") do
          label(class: "flex items-center gap-2 text-sm cursor-pointer") do
            input(
              type: "checkbox",
              name: "dosage[default_for_adults]",
              value: "1",
          ...
          label(class: "flex items-center gap-2 text-sm cursor-pointer") do
            input(
              type: "checkbox",
              name: "dosage[default_for_children]",
              value: "1",
