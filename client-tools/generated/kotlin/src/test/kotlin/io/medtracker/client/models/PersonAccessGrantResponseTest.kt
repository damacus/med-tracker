...
class PersonAccessGrantResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of PersonAccessGrantResponse
        //val modelInstance = PersonAccessGrantResponse()
