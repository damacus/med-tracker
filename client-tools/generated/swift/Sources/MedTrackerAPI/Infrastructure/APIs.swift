...
open class MedTrackerAPIAPIConfiguration: @unchecked Sendable {
    ...
    public static let shared = MedTrackerAPIAPIConfiguration()
}
...
open class RequestBuilder<T: Sendable>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: MedTrackerAPIAPIConfiguration

    /// Optional block to obtain a reference to the request's progress instance when available.
    public var onProgressReady: ((Progress) -> Void)?

    required public init(method: String, URLString: String, parameters: [String: any Sendable]?, headers: [String: String] = [:], requiresAuthentication: Bool, apiConfiguration: MedTrackerAPIAPIConfiguration = MedTrackerAPIAPIConfiguration.shared) {
        self.method = method
