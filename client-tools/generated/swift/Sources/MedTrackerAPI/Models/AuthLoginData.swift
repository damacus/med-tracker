...
public struct AuthLoginData: Sendable, Codable, Hashable {
    ...
    public init(accessToken: String, accessTokenExpiresAt: Date, refreshToken: String, refreshTokenExpiresAt: Date, household: AuthHousehold?, me: Me) {
